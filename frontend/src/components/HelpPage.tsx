export default function HelpPage() {
  return (
    <article className="page">
      ...
      <ul>
        <li>
          <strong>When someone else picks:</strong> type a few letters of the player&rsquo;s name
          and press <kbd>Enter</kbd> — the top match is removed from the board. Or click{' '}
          <strong>✕ Remove</strong> on any row.
        </li>
        <li>
          <strong>When you pick:</strong> click <strong>Mine</strong> (or hold Alt/Cmd/Shift while
          clicking ✕ Remove). The player is removed from the board and lands in the My Roster
          panel.
        </li>
        <li>
        ...
        <li>
          <strong>Suggested pick:</strong> the highlighted card above the board recommends your
          best next pick given your open roster slots — floor-weighted while you still need
          starters, ceiling-weighted once you&rsquo;re drafting bench upside.
        </li>
        <li>
          <strong>Watchlist:</strong> star players (☆ on any row, or <kbd>W</kbd>) before or
          during the draft. Starred players still available show in the ★ strip; they disappear
          automatically when drafted.
        </li>
        <li>
          <strong>Best available:</strong> the tiles above the table always show the top undrafted
          player by VOR at each position, with floor and ceiling.
        </li>
        <li>
          <strong>Player card on hover:</strong> rest your mouse anywhere on a player&rsquo;s row
          (or <kbd>Tab</kbd> to a name; works on the Best-available tiles and Suggested-pick card
          too). After a quarter second a card pops up with three quick reads — <strong>Bye
          ...
          the bottom. Rookies say so. <kbd>Esc</kbd> closes it.
        </li>
        <li>
          ...
          his fantasy points, i.e. a high weekly floor. Hover the name for the numbers behind
          either badge.
        </li>
        <li>
        ...
        <li>
          <strong>Misclicked?</strong> Every removal shows a 5-second <strong>Undo</strong> toast
          at the bottom of the screen.
        </li>
        <li>
          <strong>Light or dark:</strong> the ☀/☾ button in the top bar switches themes. Until
          you pick one, the app follows your device&rsquo;s setting automatically.
        </li>
        <li>
          <strong>Done with a position?</strong> Click the little <strong>×</strong> on a position
          chip to hide that position entirely (the roster panel will suggest this when your slots
          are full). Restore it any time from the &ldquo;hidden&rdquo; chips.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Removed the wrong player?</strong> Open the <strong>Removed</strong> tab — every
          hand-removed player, most recent first, with an <strong>↩ Add back</strong> button.
        </li>
        <li>
          <strong>Wrong player on your roster?</strong> In the My Roster panel, <strong>✕</strong>{' '}
      ...
      <p className="note">
        ...
        toggles are in the top bar. Projections come from the ffanalytics R package pipeline;
